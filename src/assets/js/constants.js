...
export const DISABLED_MARKER = {class: 'text-red-700', slice: 'markerTimes'};

export const GOSH = 0;
export const SHUCKS = 10;
export const DANG = 20;
export const DARN = 30;
export const HECK = 40;
export const FRICK = 50;
